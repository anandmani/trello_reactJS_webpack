...
var cardSource = {
  beginDrag: function(props){
    console.log("Dragging card: "+props.cardDetails.cardName);
    return {};
  }
};
...
var cardTarget = {
  drop: function(props,monitor){
    console.log("Dropping "+monitor.getItem()+" to "+props.cardDetails.cardName);
  }
};
...
// export default DropTarget('card', cardSource, collect)(Card);
